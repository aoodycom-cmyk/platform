...
assert.ok(index.includes("styles-desktop.css?v=v11-franklin-v38-20260822-local-recovery1"), "app must load the desktop responsive layer after the existing styles");
