...
assert.ok(index.includes("styles-desktop.css?v=v11-franklin-v39-20260822-static-rescue1"), "app must load the desktop responsive layer after the existing styles");
