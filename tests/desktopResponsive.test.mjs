...
assert.ok(index.includes("styles-desktop.css?v=v11-franklin-v36-20260822-earnings-loop1"), "app must load the desktop responsive layer after the existing styles");
