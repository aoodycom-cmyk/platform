...
assert.ok(index.includes("styles-desktop.css?v=v11-franklin-v37-20260822-boot-cache1"), "app must load the desktop responsive layer after the existing styles");
