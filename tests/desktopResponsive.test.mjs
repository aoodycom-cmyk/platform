...
assert.ok(index.includes("styles-desktop.css?v=v11-franklin-v35-20260822-safari-boot1"), "app must load the desktop responsive layer after the existing styles");
