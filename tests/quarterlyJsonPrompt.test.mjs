...
const script = readFileSync(new URL("../src/ui/quarterlyEarningsJsonPrompt.js", import.meta.url), "utf8");

assert.ok(index.includes("quarterlyEarningsJsonPrompt.js"));
assert.ok(sw.includes("./src/ui/quarterlyEarningsJsonPrompt.js"));
...
console.log("Quarterly JSON prompt tests passed.");
