...
assert.match(html, /src\/main\.js\?v=v53-editorial-finance/, "The changed report markup must use a fresh asset version.");
assert.match(main, /components\.js\?v=v53-editorial-finance/, "The application entry point must fetch the redesigned component module under the new asset version.");
assert.match(worker, /editorial-v53/, "The PWA cache must advance for the visual release.");
