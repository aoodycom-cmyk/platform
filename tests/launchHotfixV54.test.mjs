...
assert.match(html, /backend-config\.js\?v=earnings-header-20260905-1/, "Safari recovery configuration must bypass the previous cached detector.");
...
assert.match(html, /earnings-header-20260905-1/, "The visual refinement must bypass stale iPhone assets.");
assert.match(worker, /earnings-header-20260905-1/, "The PWA cache must advance for the visual refinement.");
