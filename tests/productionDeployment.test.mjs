...
try {
  ...
  assert.ok(app.text.includes("styles.css?v=v10-reference-20260809b"));
  assert.ok(app.text.includes("src/main.js?v=v10-reference-20260809b"));
  ...
  assert.ok(serviceWorker.text.includes("franklin-research-v10-reference-20260809b"));
