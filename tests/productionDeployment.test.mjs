...
try {
  ...
  assert.ok(app.text.includes("styles.css?v=v11-library-ui-20260820d"));
  assert.ok(app.text.includes("src/main.js?v=v11-library-ui-20260820d"));
  ...
  assert.ok(serviceWorker.text.includes("franklin-research-v11-library-ui-20260820d"));
