...
try {
  ...
  assert.ok(app.text.includes("styles.css?v=v10-issue-2-qa-followup-2-20260817"));
  assert.ok(app.text.includes("src/main.js?v=v10-issue-2-qa-followup-2-20260817"));
  ...
  assert.ok(serviceWorker.text.includes("franklin-research-v10-issue-2-qa-followup-2-20260817"));
