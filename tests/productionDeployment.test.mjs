...
try {
  ...
  assert.ok(app.text.includes("styles.css?v=v10-quarterly-requirements-20260809"));
  assert.ok(app.text.includes("src/main.js?v=v10-quarterly-requirements-20260809"));
  ...
  assert.ok(serviceWorker.text.includes("franklin-research-v10-quarterly-requirements-20260809"));
