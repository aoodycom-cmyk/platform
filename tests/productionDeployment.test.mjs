...
try {
  ...
  assert.ok(app.text.includes("styles.css?v=v10-mobile-dashboard-20260810"));
  assert.ok(app.text.includes("src/main.js?v=v10-mobile-dashboard-20260810"));
  ...
  assert.ok(serviceWorker.text.includes("franklin-research-v10-mobile-dashboard-20260810"));
