...
try {
  ...
  assert.ok(app.text.includes("styles.css?v=v10-mobile-only-release-20260816"));
  assert.ok(app.text.includes("src/main.js?v=v10-mobile-only-release-20260816"));
  ...
  assert.ok(serviceWorker.text.includes("franklin-research-v10-mobile-only-release-20260816"));
