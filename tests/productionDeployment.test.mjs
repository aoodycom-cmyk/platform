...
try {
  ...
  assert.ok(app.text.includes("styles.css?v=v10-high-impact-final-fixes-20260810"));
  assert.ok(app.text.includes("src/main.js?v=v10-high-impact-final-fixes-20260810"));
