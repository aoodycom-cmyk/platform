...
try {
  ...
  assert.ok(app.text.includes("styles.css?v=v11-franklin-v38-20260822-local-recovery1"));
  assert.ok(app.text.includes("styles-mobile2.css?v=v11-franklin-v38-20260822-local-recovery1"));
  assert.ok(app.text.includes("src/main.js?v=v11-franklin-v38-20260822-local-recovery1"));
  assert.ok(app.text.includes("franklin-cache-version-seen"));
  ...
  assert.ok(serviceWorker.text.includes("franklin-research-v11-franklin-v38-20260822-local-recovery1"));
  ...
  assert.ok(serviceWorker.text.includes("src/externalAnalysis/earningsRevaluation.js"));
  ...
  const frontendFiles = [
    ...
    "../public/src/externalAnalysis/earningsRevaluation.js"
