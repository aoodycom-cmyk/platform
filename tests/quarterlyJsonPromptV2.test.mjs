...
assert.ok(parser.includes("inflateQuarterlyEarningsLitePayload"), "Lite inflation now belongs to the parser path, not the UI helper.");
assert.ok(parser.includes("Quarterly Earnings Lite Parser"));
