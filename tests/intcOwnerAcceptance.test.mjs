...
export const canonical = {
  ...
  valuation: {
    ...
    valuationResults: [
      ...
      { method: "EV/EBIT", role: "SECONDARY", fairValue: 86, weight: 35, confidence: "MEDIUM", inputs: { normalizedEbit: 86, evEbitMultiple: 1, netDebt: 0, dilutedShares: 1 }, assumptions: { foundryLossesDecline: true }, rationale: "يوازن أثر الدين والسيولة ويعطي وزنًا لارتفاع الربحية التشغيلية.", limitations: "يتطلب افتراضات عن صافي الدين بعد تمويل الأسهم والإنفاق الرأسمالي." },
      { method: "SOTP", role: "SECONDARY", fairValue: 95, weight: 20, confidence: "LOW", inputs: { componentEquityValues: [95], corporateAdjustments: 0, dilutedShares: 1 }, assumptions: { externalFoundryScaleUp: "gradual" }, rationale: "يفصل قيمة أعمال المنتجات المربحة عن Foundry عالية المخاطر، وهو مهم لأن النتائج القطاعية متباينة جدًا.", limitations: "قيمة Foundry غير يقينية وتعتمد على 18A/14A والعملاء الخارجيين." }
    ],
    scenarios: {
