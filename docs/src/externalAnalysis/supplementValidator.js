import { getPath } from "./missingFields.js";
...
export function validateExternalAnalysisSupplement(supplement = {}, existingReport = {}) {
  ...
  for (const [path, value] of Object.entries(supplement.fields || {})) {
  ...
  validateCombinedFairValueOrdering(existingReport, supplement.fields || {}, errors);
