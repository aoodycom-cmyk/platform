...
const UI_LABELS = {
  ...
  "My Stocks": "أسهمي",
  Stocks: "أسهم",
  "Personal investment decision reference": "مرجع قراراتك الاستثمارية اليومية",
  "Investment Library": "مكتبة الاستثمار",
  "Browse saved investment decisions": "استعرض قراراتك الاستثمارية المحفوظة",
  "Franklin is where saved investment decisions live.": "Franklin يحفظ قراراتك الاستثمارية وتقارير الأسهم للرجوع إليها.",
  "Analyze / Add Stock": "تحليل / إضافة سهم",
  "No saved stocks yet.": "لا توجد أسهم محفوظة بعد",
  "Start by adding your first investment analysis.": "ابدأ بإضافة أول تحليل استثماري.",
  "Portfolio status summary": "ملخص حالة الأسهم",
  "Professional Equity Research Library": "مكتبة أبحاث أسهم احترافية",
  "Knowledge base": "قاعدة معرفة",
  "Research Library": "مكتبة الأبحاث",
  "Saved Company Reports": "تقارير الشركات المحفوظة",
  "Saved reports": "التقارير المحفوظة",
  "Browse imported equity research reports": "استعرض تقارير أبحاث الأسهم المستوردة",
  "Search saved reports by ticker or company": "ابحث داخل التقارير المحفوظة بالرمز أو اسم الشركة",
  "Franklin stores external research. It does not create investment analysis.": "Franklin يحفظ الأبحاث الخارجية وينظمها. لا يصنع التحليل الاستثماري.",
  Companies: "شركات",
  Analyses: "تحليلات",
  "No imported reports yet.": "لا توجد تقارير مستوردة بعد.",
  "Import a ChatGPT analysis to build your research library.": "استورد تحليل ChatGPT لبناء مكتبة الأبحاث.",
  "Open saved report": "فتح التقرير المحفوظ",
  Filter: "تصفية",
  Sort: "ترتيب",
  "Latest Update": "الأحدث تحديثًا",
  "Last Update": "آخر تحديث",
  "Estimate Revisions": "مراجعات تقديرات المحللين",
  "Analyst Estimate Revisions": "اتجاه تقديرات المحللين",
  "Revenue Estimates": "تقديرات Revenue",
  "EPS Estimates": "تقديرات EPS",
  "EBITDA Estimates": "تقديرات EBITDA",
  "Overall Trend": "الاتجاه العام",
  "Days": "يومًا",
  "Period unavailable": "الفترة غير متوفرة",
  "As of": "كما في",
  "Positive": "إيجابي",
  "Neutral": "محايد",
  "Negative": "سلبي",
  ...
  "Highest Upside": "أعلى عائد محتمل",
  "Last Analysis": "آخر تحليل",
  "Company Report": "تقرير الشركة",
  "Stored external research": "بحث خارجي محفوظ",
  "Company-Specific KPIs": "مؤشرات الشركة الخاصة",
  "Investment Decision Section": "القرار الاستثماري",
  "Fair Value and Next Target": "القيمة العادلة والهدف القادم",
  "Company Execution": "تنفيذ الشركة",
  "Forward View": "النظرة القادمة",
  "Investment Foundation": "أساس الاستثمار",
  "Risks Section": "المخاطر",
  "Valuation Section": "التقييم",
  "History and Sources": "السجل والمصادر",
  "Section 1": "القسم 1",
  "Section 2": "القسم 2",
  "Section 3": "القسم 3",
  "Section 4": "القسم 4",
  ...
  "Section 7": "القسم 7",
  "Section 8": "القسم 8",
  "Requirements to Justify Next Price Target": "متطلبات تبرير السعر المستهدف التالي",
  "Earnings Requirement Results": "نتائج تحقق متطلبات الأرباح",
  "Historical Requirements": "المتطلبات التاريخية",
  "Matched previous requirement set": "تم ربط مجموعة المتطلبات السابقة",
  "Suggested previous requirement set": "مجموعة متطلبات سابقة مقترحة",
  "Select the requirement set this earnings report should evaluate.": "اختر مجموعة المتطلبات التي يقيمها تقرير الأرباح هذا.",
  "Franklin found more than one open requirement set and will not choose silently.": "وجد Franklin أكثر من مجموعة مفتوحة ولن يختار واحدة تلقائيًا.",
  Created: "تم الإنشاء",
  Requirements: "متطلبات",
  "Earnings period": "فترة الأرباح",
  "LAST EARNINGS EXECUTION": "نتيجة الإعلان الأخير",
  "Latest Earnings Execution": "نتيجة الإعلان الأخير",
  "Earnings Snapshot": "ملخص الإعلان",
  "Historical Analyses": "التحليلات السابقة",
  Overall: "النتيجة العامة",
  "NEXT EARNINGS REQUIREMENTS": "متطلبات الأرباح القادمة",
  "Guidance Next": "توجيهات الشركة القادمة",
  "Why We Own or Watch This Stock": "لماذا نملك أو نراقب هذا السهم؟",
  "Company Quality": "جودة الشركة",
  "Average Cost": "متوسط التكلفة",
  "Bear Case": "السيناريو المتحفظ Bear Case",
  "Base Case": "السيناريو الأساسي Base Case",
  "Bull Case": "السيناريو المتفائل Bull Case",
  "Bear Scenario Label": "السيناريو المتحفظ",
  "Base Scenario Label": "السيناريو الأساسي",
  "Bull Scenario Label": "السيناريو المتفائل",
  "Bear Fair Value": "القيمة العادلة المتحفظة Bear Fair Value",
  "Base Fair Value": "القيمة العادلة الأساسية Base Fair Value",
  "Bull Fair Value": "القيمة العادلة المتفائلة Bull Fair Value",
  "Recommendation Upgrade / Downgrade Conditions": "شروط رفع أو خفض التوصية",
  "Growth Details": "تفاصيل النمو",
  "Target being tested": "الهدف الجاري اختباره",
  "Requirement achievement": "نسبة تحقق المتطلبات",
  "Requirement Delivery Timeline": "خط تسليم المتطلبات",
  Target: "الهدف",
  evaluated: "تم تقييمها",
  "Valuation Method Used": "طريقة التقييم المستخدمة",
  "Growth Section": "النمو",
  "Action": "الإجراء",
  "What Would Upgrade": "ما الذي يرفع التوصية",
  "What Would Downgrade": "ما الذي يخفض التوصية",
  "Severity": "حدة الخطر",
  "What to Monitor": "ماذا نراقب؟",
  "Thesis Breaker": "متى تصبح الأطروحة مكسورة؟",
  "Previous Guidance": "التوجيه السابق",
  "Raised": "مرفوع",
  "Maintained": "مثبت",
  "Lowered": "مخفض",
  "New": "جديد",
  ...
  "Customer": "العميل",
  "Pricing": "التسعير",
  "Backlog": "الطلبات المتعاقد عليها Backlog",
  "Operational": "تشغيلي",
  "Other": "أخرى",
  "KPI": "مؤشر أداء رئيسي KPI",
  "Economic Moat": "الخندق الاقتصادي Economic Moat",
  "Revenue Growth": "نمو الإيرادات Revenue Growth",
  "EPS Growth": "نمو EPS",
  "FCF Growth": "نمو FCF",
  "Margin Trend": "اتجاه الهوامش",
  "Segment Growth": "نمو القطاع",
  "TAM": "TAM (حجم السوق الممكن)",
  "Current Justified Value": "القيمة المبررة الحالية",
  "Next Target": "الهدف التالي",
  "Target Scenario": "السيناريو المستهدف",
  "Earnings Period": "فترة النتائج",
  "Previous Quarter": "الربع السابق",
  "Target Quarter": "الربع المستهدف",
  "Next Quarter": "الربع القادم",
  "Next Quarter Guidance": "توجيهات الربع القادم",
  "Figures": "أرقام",
  "Required To Justify": "المطلوب لتبرير",
  "What We Monitor": "ما نتابعه",
  "What must the company deliver to justify": "ما المطلوب من الشركة لتبرير",
  "Waiting for announcement": "بانتظار الإعلان",
  "Direction Up": "اتجاه الرقم للأعلى",
  "Direction Down": "اتجاه الرقم للأسفل",
  "Direction Flat": "اتجاه الرقم مستقر",
  "Investment Impact": "الأثر الاستثماري",
  "Requirement": "المتطلب",
  Metric: "المؤشر",
  "Required": "المطلوب",
  "Target Quarter": "الربع المستهدف",
  ...
  "Status": "الحالة",
  "Weight": "الوزن",
  "Exceeded": "تجاوز المطلوب",
  "Passed": "تحقق",
  "Partially Passed": "تحقق جزئيًا",
  "Failed": "لم يتحقق",
  "Not Reported": "لم يتم الإفصاح",
  "Weighted Achievement": "نسبة تحقق المتطلبات",
  "Reported Requirements": "المتطلبات المعلنة",
  "Passed": "تحقق",
  "Failed": "لم يتحقق",
  "Exceeded": "تجاوز المطلوب",
  "Thesis Status": "حالة الفرضية",
  "Bull Case Strengthened": "Bull Case تعزز",
  "Bull Case Unchanged": "Bull Case لم يتغير",
  "Bull Case Weakened": "Bull Case ضعف",
  "Thesis Strengthened": "الفرضية تعززت",
  "Thesis Weakened": "الفرضية ضعفت",
  "Thesis Broken": "الفرضية انكسرت",
  "Primary Valuation Method": "طريقة التقييم الأساسية",
  "Valuation Methods Used": "طرق التقييم المستخدمة",
  "Price Target Requirements": "متطلبات السعر",
  "Quarterly Scorecard": "متابعة الأرباع",
  "Annual execution": "التنفيذ السنوي",
  "Awaiting report": "بانتظار الإعلان",
  "Reported": "معلن",
  "Not enough reported quarters": "لا توجد أرباع معلنة كافية",
  "Stored quarter detail": "تفاصيل الربع المحفوظة",
  "No stored evaluation note is available.": "لا توجد ملاحظة تقييم محفوظة لهذا الربع.",
  "No quarterly requirement history is available for this stock.": "لا يوجد سجل متطلبات ربعي محفوظ لهذا السهم.",
  ...
  "Trend": "الاتجاه",
  "Weakening": "يضعف",
  "Compare / Monitor / Decide": "قارن / راقب / قرر",
  Evidence: "الأدلة",
  "Full thesis": "الأطروحة الكاملة",
  "Strengths & Risks": "المزايا والمخاطر",
  "More Evidence": "أدلة إضافية",
  Details: "التفاصيل",
  "Show details": "عرض التفاصيل",
  "Open details for": "فتح تفاصيل",
  "Full text": "النص الكامل",
  Explanation: "التفسير",
  "Why it matters": "لماذا يهم؟",
  "Evaluation note": "ملاحظة التقييم",
  Notes: "ملاحظات",
  Catalyst: "محفز",
  "Risk item": "مخاطرة",
  "Watch item": "عنصر متابعة",
  Strength: "نقطة قوة",
  "Evidence details": "تفاصيل العنصر",
  Focus: "محور المتابعة",
  Close: "إغلاق",
  "Result explanation": "تفسير النتيجة",
  Direction: "الاتجاه",
  Positive: "إيجابي",
  Negative: "سلبي",
  Mixed: "مختلط",
  Neutral: "محايد",
  "No verified strengths were provided.": "لا توجد مزايا موثقة في التحليل المستورد.",
  "Financial Performance": "الأداء المالي",
  "Company KPIs": "مؤشرات الشركة",
  Value: "القيمة",
  Period: "الفترة",
  Change: "التغير",
  Trend: "الاتجاه",
  ...
  "Role": "الدور",
  "Output Value": "القيمة الناتجة",
  "Primary": "أساسية",
  "Supporting": "مساندة",
  "Why did we use this method?": "لماذا استخدمنا هذه الطريقة؟",
  "Key Assumptions": "الافتراضات الرئيسية",
  "Method Limitation": "محدودية الطريقة",
  "Technical Details": "تفاصيل فنية",
  "Multiple Used": "المضاعف المستخدم",
  "Time Horizon": "الأفق الزمني",
  "Investment Data": "بيانات الاستثمار",
  ...
  "تحليل إعلان جديد": "تحليل إعلان جديد",
  "Company Profile": "عن الشركة",
  "Company profile unavailable": "ملف الشركة غير متوفر",
  "This saved analysis does not include an educational company profile.": "هذا التحليل المحفوظ لا يحتوي على شرح تعليمي للشركة.",
  "What does the company do?": "ماذا تفعل الشركة؟",
  "How does the company make money?": "كيف تكسب الشركة أموالها؟",
  "Company Activities": "أنشطة الشركة",
  "What is it?": "ما هو؟",
  "Why does it matter?": "لماذا يهم الشركة؟",
  "Who are its customers?": "من هم عملاؤها؟",
  "Main Growth Drivers": "محركات النمو الرئيسية",
  "Edit Current Report": "تعديل هذا التقرير",
  "is saved in My Stocks.": "محفوظ في أسهمي.",
  "Advanced Options": "خيارات متقدمة",
  "Use only if ChatGPT asks for the raw JSON shape.": "استخدمه فقط إذا احتجت قالب JSON الخام.",
  "Export and Restore": "تصدير واستعادة",
  "Export saved Franklin reports, history, settings, and watch data. API keys are never included.": "صدّر تقارير Franklin المحفوظة والسجل والإعدادات وبيانات المتابعة. لا يتم تضمين مفاتيح API أبدًا.",
  "Export All Investment Data": "تصدير كل بيانات الاستثمار",
  "Restore Investment Data": "استعادة بيانات الاستثمار",
  "Backup is not valid": "النسخة الاحتياطية غير صالحة",
  "Restore Preview": "معاينة الاستعادة",
  "Merge Backup": "دمج النسخة",
  "Replace Local Data": "استبدال البيانات المحلية",
  "Replace current local Franklin data with this backup?": "هل تريد استبدال بيانات Franklin المحلية الحالية بهذه النسخة؟",
  "Open DEMO External Report": "فتح تقرير DEMO خارجي",
  "Investment Verdict": "الحكم الاستثماري",
  "Watch List": "قائمة المتابعة",
  "Financial Highlights": "أبرز البيانات المالية",
  "Raw Analysis": "التحليل الخام",
  ...
  "ChatGPT Contract": "عقد Fair value",
  "جهّز ChatGPT قبل اللصق": "جهّز ChatGPT قبل اللصق",
  "Copy the official prompt, send it to ChatGPT, then paste the JSON response here.": "انسخ برومبت Fair value الرسمي، أرسله إلى ChatGPT، ثم الصق رد JSON هنا.",
  "نسخ برومبت تحليل السهم": "نسخ برومبت تحليل السهم",
  "نسخ JSON Template": "نسخ JSON Template",
  "Required fields before saving": "الحقول المطلوبة قبل الحفظ",
  Parse: "استخراج",
  Save: "حفظ",
  "Open Report": "فتح التقرير",
  "Review before saving": "راجع قبل الحفظ",
  "Advanced JSON": "JSON متقدم",
  "Review prior saved analyses. Drafts are never shown here.": "راجع التحليلات المحفوظة السابقة. المسودات لا تظهر هنا.",
  "Data Completion": "اكتمال البيانات",
  "Data Health": "صحة البيانات",
  Complete: "مكتمل",
  Incomplete: "غير مكتمل",
  Draft: "مسودة",
  "Has Conflicts": "يوجد تعارض",
  Invalid: "غير صالح",
  "Required fields": "الحقول المطلوبة",
  "Recommended fields": "الحقول المستحسنة",
  "Optional fields missing": "حقول اختيارية ناقصة",
  "Downside case": "الحالة المتشائمة",
  "Upside case": "الحالة المتفائلة",
  "Official source": "مصدر رسمي",
  "News source": "مصدر إخباري",
  "Manual source": "مصدر يدوي",
  "Open Source": "فتح المصدر ↗",
  "Blended Valuation": "تقييم مدمج",
  "All required data is complete.": "كل الحقول المطلوبة مكتملة.",
  "All critical data is complete and the report is ready.": "كل البيانات الحرجة مكتملة والتقرير جاهز للقراءة.",
  "Some required data is still missing.": "بعض البيانات المطلوبة ما زالت ناقصة.",
  "Conflicting fields need review before the report is complete.": "توجد حقول متعارضة تحتاج مراجعة قبل اكتمال التقرير.",
  "Validation found fields that need review.": "التحقق وجد حقولًا تحتاج مراجعة.",
  "This report is saved as an incomplete draft.": "هذا التقرير محفوظ كمسودة غير مكتملة.",
  "بيانات التقرير غير مكتملة": "بيانات التقرير غير مكتملة",
  of: "من",
  "required fields complete": "حقول مطلوبة مكتملة",
  "Invalid fields": "حقول غير صحيحة",
  Warnings: "تحذيرات",
  "No critical missing fields.": "لا توجد حقول حرجة ناقصة.",
  "Recommended missing fields": "حقول مستحسنة ناقصة",
  "نسخ النواقص": "نسخ النواقص",
  "إضافة بيانات مكملة": "إضافة بيانات مكملة",
  "تعديل يدوي": "تعديل يدوي",
  "الحفظ كمسودة": "الحفظ كمسودة",
  "Clipboard fallback": "نسخ يدوي احتياطي",
  "Select All": "تحديد الكل",
  "Copy Again": "نسخ مرة أخرى",
  Current: "القيمة الحالية",
  Recommended: "مستحسن",
  Supplement: "استكمال",
  "إكمال البيانات الناقصة": "إكمال البيانات الناقصة",
  "fields requested": "حقول مطلوبة",
  "Paste supplementary ChatGPT response here.": "ألصق رد ChatGPT التكميلي هنا.",
  "Parse Supplement": "قراءة البيانات المكملة",
  "Applied fields": "حقول مدمجة",
  Conflicts: "تعارضات",
  "Rejected fields": "حقول مرفوضة",
  "Conflict Review": "مراجعة التعارضات",
  "Current value": "القيمة الحالية",
  "New value": "القيمة الجديدة",
  "Keep current": "الاحتفاظ بالحالية",
  "Use new": "استخدام الجديدة",
  "Manual value": "قيمة يدوية",
  Manual: "يدوي",
  "Merge Supplement": "دمج البيانات المكملة",
  "Manual Edit": "تعديل يدوي",
  "تعديل الحقول الناقصة": "تعديل الحقول الناقصة",
  ...
  "New Analysis": "تحليل جديد",
  Import: "استيراد",
  "Import ChatGPT Analysis": "استيراد تحليل ChatGPT",
  "External ChatGPT": "ChatGPT خارجي",
  "External ChatGPT Analysis": "تحليل ChatGPT خارجي",
  "Import Analysis": "استيراد تحليل",
  "Imported Reports": "التقارير المستوردة",
  "These reports use the pasted ChatGPT values directly. Internal valuation engines are not re-run.": "هذه التقارير تستخدم قيم ChatGPT الملصقة كما هي. لا يتم تشغيل محركات التقييم الداخلية.",
  "Paste a completed ChatGPT analysis. This path parses, validates, previews, and saves only. It never re-runs internal valuation engines.": "ألصق تحليل ChatGPT جاهزًا. هذا المسار يستخرج ويتحقق ويعرض ويحفظ فقط، ولا يعيد تشغيل محركات التقييم الداخلية.",
  "Paste completed ChatGPT analysis or ExternalAnalysisReport JSON here.": "ألصق هنا تحليل Fair value كاملًا أو JSON بصيغة fair-value-analysis/v2.",
  "Parse Analysis": "استخراج التحليل",
  Parsing: "جاري الاستخراج",
  Cancel: "إلغاء",
  Parser: "المستخرج",
  Preview: "معاينة",
  "Validation Errors": "أخطاء التحقق",
  "Validation Warnings": "تنبيهات التحقق",
  "This analysis already exists.": "هذا التحليل موجود مسبقًا.",
  "Save duplicate anyway": "حفظ نسخة مكررة",
  ...
  "Decision Rationale": "سبب القرار",
  "Edit Fields": "تعديل الحقول",
  "Advanced editor. Edit any field in JSON, then leave the field to re-validate.": "محرر متقدم. عدّل أي حقل داخل JSON ثم اخرج من الحقل لإعادة التحقق.",
  "No internal recalculation": "بدون إعادة حساب داخلي",
  "No imported report selected.": "لم يتم اختيار تقرير مستورد.",
  "Business Quality": "جودة الأعمال",
  "Earnings Quality": "جودة الأرباح",
  "Risks": "المخاطر",
  "Catalysts": "المحفزات",
  "Watch Items": "عناصر المتابعة",
  "Decision / Verdict": "القرار / الحكم",
  "Version History": "سجل النسخ",
  "Raw ChatGPT Analysis": "نص ChatGPT الأصلي",
  "Not provided in the imported analysis.": "غير مذكور في التحليل المستورد.",
  "Copy JSON": "نسخ JSON",
  "Export JSON": "تصدير JSON",
  "Print Report": "طباعة التقرير",
  "Edit imported analysis": "تعديل التحليل المستورد",
  "Delete version": "حذف النسخة",
  "Delete all analyses for ticker": "حذف كل تحليلات السهم",
  "Delete this imported analysis version?": "هل تريد حذف نسخة التحليل المستورد؟",
  "Delete all imported analyses for this ticker?": "هل تريد حذف كل التحليلات المستوردة لهذا السهم؟",
  "Imported external report": "تقرير خارجي مستورد",
  ...
  "Composite FV": "القيمة العادلة المركبة Composite Fair Value",
  "Composite Fair Value": "القيمة العادلة المركبة Composite Fair Value",
  ...
  "Enterprise Value": "قيمة المنشأة Enterprise Value",
  Currency: "العملة",
  Industry: "الصناعة",
  "Current Date": "التاريخ الحالي",
  "Gross Profit": "إجمالي الربح Gross Profit",
  "Operating Income": "الدخل التشغيلي Operating Income",
  "Net Income": "صافي الدخل Net Income",
  ...
  Equity: "حقوق الملكية",
  "Working Capital": "رأس المال العامل Working Capital",
  "Diluted Shares Outstanding": "الأسهم المخففة القائمة",
  "Operating Cash Flow": "التدفق النقدي التشغيلي Operating Cash Flow",
  "Capital Expenditure": "CapEx",
  "Stock-Based Compensation": "تعويضات الأسهم Stock-Based Compensation",
  "Share Buybacks": "إعادة شراء الأسهم",
  Dividends: "التوزيعات",
  "Revenue Guidance": "توجيهات Revenue",
  "EPS Guidance": "توجيهات EPS",
  "Margin Guidance": "توجيهات الهوامش",
  "CapEx Guidance": "توجيهات CapEx",
  "Management Growth Guidance": "توجيهات Management للنمو",
  "Other guidance": "Guidance أخرى",
  "Revenue Estimates": "تقديرات Revenue",
  "EPS Estimates": "تقديرات EPS",
  "EBITDA Estimates": "تقديرات EBITDA",
  "FCF Estimates": "تقديرات FCF",
  ...
  "Economic Moat": "الخندق الاقتصادي Economic Moat",
  "Capital Allocation": "تخصيص رأس المال Capital Allocation",
...
const EN_UI_LABELS = {
  ...
  "My Stocks": "My Stocks",
  Stocks: "Stocks",
  "Personal investment decision reference": "Personal investment decision reference",
  "Investment Library": "Investment Library",
  "Browse saved investment decisions": "Browse saved investment decisions",
  "Franklin is where saved investment decisions live.": "Franklin is where saved investment decisions live.",
  "Analyze / Add Stock": "Analyze / Add Stock",
  "No saved stocks yet.": "No saved stocks yet.",
  "Start by adding your first investment analysis.": "Start by adding your first investment analysis.",
  "Portfolio status summary": "Portfolio status summary",
  "Professional Equity Research Library": "Professional Equity Research Library",
  "Knowledge base": "Knowledge base",
  "Research Library": "Research Library",
  "Saved Company Reports": "Saved Company Reports",
  "Saved reports": "Saved reports",
  "Browse imported equity research reports": "Browse imported equity research reports",
  "Search saved reports by ticker or company": "Search saved reports by ticker or company",
  "Franklin stores external research. It does not create investment analysis.": "Franklin stores external research. It does not create investment analysis.",
  Companies: "Companies",
  Analyses: "Analyses",
  "No imported reports yet.": "No imported reports yet.",
  "Import a ChatGPT analysis to build your research library.": "Import a ChatGPT analysis to build your research library.",
  "Open saved report": "Open saved report",
  Filter: "Filter",
  Sort: "Sort",
  ...
  "Stored external research": "Stored external research",
  "Company-Specific KPIs": "Company-Specific KPIs",
  "Investment Decision Section": "Investment Decision",
  "Fair Value and Next Target": "Fair Value and Next Target",
  "Company Execution": "Company Execution",
  "Forward View": "Forward View",
  "Investment Foundation": "Investment Foundation",
  "Risks Section": "Risks",
  "Valuation Section": "Valuation",
  "History and Sources": "History and Sources",
  "Section 1": "Section 1",
  "Section 2": "Section 2",
  "Section 3": "Section 3",
  "Section 4": "Section 4",
  ...
  "Section 7": "Section 7",
  "Section 8": "Section 8",
  "Requirements to Justify Next Price Target": "Requirements to Justify Next Price Target",
  "Earnings Requirement Results": "Earnings Requirement Results",
  "Latest Earnings Execution": "Latest Earnings Execution",
  "Earnings Snapshot": "Earnings Snapshot",
  "Historical Analyses": "Historical Analyses",
  Overall: "Overall",
  "Guidance Next": "Guidance Next",
  "Why We Own or Watch This Stock": "Why We Own or Watch This Stock",
  "Company Quality": "Company Quality",
  "Average Cost": "Average Cost",
  "Bear Case": "Bear Case",
  "Base Case": "Base Case",
  "Bull Case": "Bull Case",
  "Bear Scenario Label": "Bear",
  "Base Scenario Label": "Base",
  "Bull Scenario Label": "Bull",
  "Bear Fair Value": "Bear Fair Value",
  "Base Fair Value": "Base Fair Value",
  "Bull Fair Value": "Bull Fair Value",
  "Recommendation Upgrade / Downgrade Conditions": "Recommendation Upgrade / Downgrade Conditions",
  "Growth Details": "Growth Details",
  "Growth Section": "Growth",
  "Valuation Method Used": "Valuation Method Used",
  Action: "Action",
  "What Would Upgrade": "What Would Upgrade",
  "What Would Downgrade": "What Would Downgrade",
  Severity: "Severity",
  "What to Monitor": "What to Monitor",
  "Thesis Breaker": "Thesis Breaker",
  ...
  Other: "Other",
  KPI: "KPI",
  "Current Justified Value": "Current Justified Value",
  ...
  "Weighted Achievement": "Weighted Achievement",
  "Reported Requirements": "Reported Requirements",
  "Thesis Status": "Thesis Status",
  "Bull Case Strengthened": "Bull Case Strengthened",
  "Bull Case Unchanged": "Bull Case Unchanged",
  "Bull Case Weakened": "Bull Case Weakened",
  "Thesis Strengthened": "Thesis Strengthened",
  "Thesis Weakened": "Thesis Weakened",
  "Thesis Broken": "Thesis Broken",
  "Primary Valuation Method": "Primary Valuation Method",
  "Valuation Methods Used": "Valuation Methods Used",
  Method: "Method",
  "طريقة التقييم": "Valuation Method",
  Role: "Role",
  "Output Value": "Output Value",
  Primary: "Primary",
  Supporting: "Supporting",
  "Why did we use this method?": "Why did we use this method?",
  "Key Assumptions": "Key Assumptions",
  "Method Limitation": "Method Limitation",
  "Technical Details": "Technical Details",
  "Multiple Used": "Multiple Used",
  "Time Horizon": "Time Horizon",
  "Investment Data": "Investment Data",
  "Export and Restore": "Export and Restore",
  "Export saved Franklin reports, history, settings, and watch data. API keys are never included.": "Export saved Franklin reports, history, settings, and watch data. API keys are never included.",
  "Export All Investment Data": "Export All Investment Data",
  "Restore Investment Data": "Restore Investment Data",
  "Backup is not valid": "Backup is not valid",
  "Restore Preview": "Restore Preview",
  "Merge Backup": "Merge Backup",
  "Replace Local Data": "Replace Local Data",
  "Replace current local Franklin data with this backup?": "Replace current local Franklin data with this backup?",
  "Open DEMO External Report": "Open DEMO External Report",
  "Investment Verdict": "Investment Verdict",
  "Watch List": "Watch List",
  "Financial Highlights": "Financial Highlights",
  "Raw Analysis": "Raw Analysis",
  "Company Profile": "Company Profile",
  "Company profile unavailable": "Company profile unavailable",
  "This saved analysis does not include an educational company profile.": "This saved analysis does not include an educational company profile.",
  "What does the company do?": "What does the company do?",
  "How does the company make money?": "How does the company make money?",
  "Company Activities": "Company Activities",
  "What is it?": "What is it?",
  "Why does it matter?": "Why does it matter?",
  "Who are its customers?": "Who are its customers?",
  "Main Growth Drivers": "Main Growth Drivers",
  "Paste external research": "Paste external research",
  "Paste a completed ChatGPT analysis. Franklin parses, previews, saves, then opens the report. It does not create the analysis.": "Paste a completed ChatGPT analysis. Franklin parses, previews, saves, then opens the report. It does not create the analysis.",
  "Import flow": "Import flow",
  "Ticker Symbol": "Ticker Symbol",
  "Use this when the pasted report does not clearly include the ticker.": "Use this when the pasted report does not clearly include the ticker.",
  "ChatGPT Contract": "Fair value Contract",
  "جهّز ChatGPT قبل اللصق": "Prepare ChatGPT before pasting",
  "Copy the official prompt, send it to ChatGPT, then paste the JSON response here.": "Copy the official Fair value prompt, send it to ChatGPT, then paste the JSON response here.",
  "نسخ برومبت تحليل السهم": "Copy stock analysis prompt",
  "نسخ JSON Template": "Copy JSON Template",
  "Required fields before saving": "Required fields before saving",
  Parse: "Parse",
  Save: "Save",
  "Open Report": "Open Report",
  "Review before saving": "Review before saving",
  "Advanced JSON": "Advanced JSON",
  "Review prior saved analyses. Drafts are never shown here.": "Review prior saved analyses. Drafts are never shown here.",
  ...
  "Optional fields missing": "Optional fields missing",
  "Downside case": "Downside case",
  "Upside case": "Upside case",
  "Official source": "Official source",
  "News source": "News source",
  "Manual source": "Manual source",
  "Open Source": "Open source ↗",
  "Blended Valuation": "Blended Valuation",
  "All required data is complete.": "All required data is complete.",
  "All critical data is complete and the report is ready.": "All critical data is complete and the report is ready.",
  "Some required data is still missing.": "Some required data is still missing.",
  "Conflicting fields need review before the report is complete.": "Conflicting fields need review before the report is complete.",
  "Validation found fields that need review.": "Validation found fields that need review.",
  "This report is saved as an incomplete draft.": "This report is saved as an incomplete draft.",
  "بيانات التقرير غير مكتملة": "Report data is incomplete",
  of: "of",
  "required fields complete": "required fields complete",
  "Invalid fields": "Invalid fields",
  Warnings: "Warnings",
  "No critical missing fields.": "No critical missing fields.",
  "Recommended missing fields": "Recommended missing fields",
  "نسخ النواقص": "Copy missing requirements",
  "إضافة بيانات مكملة": "Add supplementary data",
  "تعديل يدوي": "Manual edit",
  "الحفظ كمسودة": "Save as draft",
  ...
  "إكمال البيانات الناقصة": "Complete missing data",
  "fields requested": "fields requested",
  "Paste supplementary ChatGPT response here.": "Paste supplementary ChatGPT response here.",
  "Parse Supplement": "Parse Supplement",
  ...
  Manual: "Manual",
  "Merge Supplement": "Merge Supplement",
  "Manual Edit": "Manual Edit",
  "تعديل الحقول الناقصة": "Edit missing fields",
  ...
  "New Analysis": "New Analysis",
  Import: "Import",
  "Import ChatGPT Analysis": "Import ChatGPT Analysis",
  "External ChatGPT": "External ChatGPT",
  "External ChatGPT Analysis": "External ChatGPT Analysis",
  "Import Analysis": "Import Analysis",
  "Imported Reports": "Imported Reports",
  "These reports use the pasted ChatGPT values directly. Internal valuation engines are not re-run.": "These reports use the pasted ChatGPT values directly. Internal valuation engines are not re-run.",
  "Paste a completed ChatGPT analysis. This path parses, validates, previews, and saves only. It never re-runs internal valuation engines.": "Paste a completed ChatGPT analysis. This path parses, validates, previews, and saves only. It never re-runs internal valuation engines.",
  "Paste completed ChatGPT analysis or ExternalAnalysisReport JSON here.": "Paste completed Fair value analysis or fair-value-analysis/v2 JSON here.",
  ...
  "This analysis already exists.": "This analysis already exists.",
  "Save duplicate anyway": "Save duplicate anyway",
  ...
  "Advanced editor. Edit any field in JSON, then leave the field to re-validate.": "Advanced editor. Edit any field in JSON, then leave the field to re-validate.",
  "No internal recalculation": "No internal recalculation",
  "No imported report selected.": "No imported report selected.",
  ...
  "Raw ChatGPT Analysis": "Raw ChatGPT Analysis",
  "Not provided in the imported analysis.": "Not provided in the imported analysis.",
  "Copy JSON": "Copy JSON",
  "Export JSON": "Export JSON",
  "Print Report": "Print Report",
  "Edit imported analysis": "Edit imported analysis",
  "Delete version": "Delete version",
  "Delete all analyses for ticker": "Delete all analyses for ticker",
  "Delete this imported analysis version?": "Delete this imported analysis version?",
  "Delete all imported analyses for this ticker?": "Delete all imported analyses for this ticker?",
  "Imported external report": "Imported external report",
  ...
  "Price at Analysis": "Price at Analysis",
  "Base Fair Value": "Base Fair Value",
  Upside: "Upside",
  "Range FV": "Range FV",
  "Upside %": "Upside %",
  ...
  "Back to My Stocks": "Back to My Stocks",
  "Add New Analysis": "Add New Analysis",
  "Analyze New Earnings": "Analyze New Earnings",
  "تحليل إعلان جديد": "Analyze New Earnings",
  "Edit Current Report": "Edit Current Report",
  "is saved in My Stocks.": "is saved in My Stocks.",
  "Advanced Options": "Advanced Options",
  "Use only if ChatGPT asks for the raw JSON shape.": "Use only if ChatGPT asks for the raw JSON shape.",
