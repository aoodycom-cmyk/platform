const CACHE_NAME = "franklin-research-v11-franklin-mobile-v2-v52-editorial-v57-earnings-single-source";
const STATIC_ASSETS = [
  "./offline.html",
  "./rescue.html",
  "./backend-config.js",
