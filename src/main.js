...
import { mountApp } from "./ui/components.js?v=compact-visual-20260901-1";
...
async function installOptionalRuntime(store, cloud, auditBootstrapError) {
  ...
  await loadOptional("./ui/stockWorkspaceNavigation.js?v=compact-visual-20260901-1", "Shared stock workspace");
  ...
  const optionalModules = [
    ...
    loadOptional("./ui/reportPresentationEditor.js?v=compact-visual-20260901-1", "Report presentation editor")
  ];
