...
const UI_LABELS = {
  ...
  "Bear Case": "Bear Case (السيناريو المتحفظ)",
  "Base Case": "Base Case (السيناريو الأساسي)",
  "Bull Case": "Bull Case (السيناريو المتفائل)",
  "Bear Fair Value": "Bear Fair Value (القيمة العادلة المتحفظة)",
  "Base Fair Value": "Base Fair Value (القيمة العادلة الأساسية)",
  "Bull Fair Value": "Bull Fair Value (القيمة العادلة المتفائلة)",
  ...
  "Customer": "العميل",
  "Pricing": "التسعير",
  "Backlog": "Backlog (الطلبات المتعاقد عليها)",
  "Operational": "تشغيلي",
  "Other": "أخرى",
  "KPI": "KPI (مؤشر أداء رئيسي)",
  "Economic Moat": "Economic Moat (الخندق الاقتصادي)",
  ...
  "Exceeded": "تجاوز",
  "Passed": "نجح",
  "Partially Passed": "نجح جزئيًا",
  "Failed": "فشل",
  "Not Reported": "غير معلن",
