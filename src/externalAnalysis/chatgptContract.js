...
function jsonOutputSafetyPromptLines() {
  return [
    ...
    "- The first non-whitespace character of the answer must be: {",
    "- The last non-whitespace character must be: }",
    "- Do not output Markdown.",
    "- Do not use code fences.",
    "- Do not write any prose before or after the JSON.",
    "- The result must be valid JSON that can be parsed by JSON.parse() without modification.",
    ...
    "4. No Markdown code fences exist.",
