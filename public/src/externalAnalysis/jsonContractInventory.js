export const JSON_CONTRACT_INVENTORY = Object.freeze([
  ...
  inventory("quarterly-earnings-lite/v2", "Auditable focused earnings update", "quarterly-earnings", "validateQuarterlyEarningsLitePayload", "inflateQuarterlyEarningsLitePayload", "external-analysis-report/v2", "externalAnalyses + quarterlyEarningsHistory", "Earnings workspace"),
  inventory("quarterly-earnings-lite/v1", "Legacy focused earnings update", "quarterly-earnings", "validateQuarterlyEarningsLitePayload (legacy compatibility)", "inflateQuarterlyEarningsLitePayload", "external-analysis-report/v2", "externalAnalyses + quarterlyEarningsHistory", "Earnings workspace"),
