...
function previousRequirementTemplate(item = {}) {
  return {
    ...
    type: item.type || null,
    baselineValue: item.baselineValue ?? item.previousValue ?? item.currentLevel ?? null,
    baselineDisplay: item.baselineDisplay || item.previousDisplay || null,
    previousValue: item.previousValue ?? item.baselineValue ?? item.currentLevel ?? null,
    previousDisplay: item.previousDisplay || item.baselineDisplay || null,
