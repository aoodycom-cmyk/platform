...
const UI_LABELS = {
  ...
  "Copy the official prompt, send it to ChatGPT, then import the downloadable JSON file here.": "انسخ برومبت Fair value الرسمي وأرسله إلى ChatGPT، ثم نزّل ملف JSON الجاهز واستورده هنا.",
  ...
  "Paste completed ChatGPT analysis or ExternalAnalysisReport JSON here.": "ألصق هنا JSON تحليل Franklin v3 أو تقرير Franklin محفوظ سابقًا.",
...
const EN_UI_LABELS = {
  ...
  "Copy the official prompt, send it to ChatGPT, then import the downloadable JSON file here.": "Copy the official Fair value prompt, send it to ChatGPT, then import the downloadable JSON file here.",
  ...
  "Paste completed ChatGPT analysis or ExternalAnalysisReport JSON here.": "Paste completed Franklin v3 JSON or a saved Franklin report here.",
